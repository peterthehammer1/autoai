...
const TOUR_STEPS = [
  {
    element: '[data-tour="apt-quick-actions"]',
    popover: {
      title: 'Quick Actions',
      description: 'Update status, check in, or send a confirmation SMS.',
      side: 'bottom',
      align: 'start',
    },
  },
  {
    element: '[data-tour="apt-customer-info"]',
    popover: {
      title: 'Customer Details',
      description: 'Contact info and a link to the full customer profile.',
      side: 'bottom',
      align: 'start',
    },
  },
  {
    element: '[data-tour="apt-vehicle-info"]',
    popover: {
      title: 'Vehicle Information',
      description: 'Make, model, year, and plate at a glance.',
      side: 'bottom',
      align: 'start',
    },
  },
  {
    element: '[data-tour="apt-services"]',
    popover: {
      title: 'Services & Pricing',
      description: 'Services with duration and pricing. Head back to the dashboard to continue the tour!',
      side: 'top',
      align: 'start',
    },
  },
...
export function useAppointmentTour(ready = false) {
  ...
  useEffect(() => {
    ...
    const startTour = () => {
      try {
        ...
        console.warn('Appointment tour failed to start:', e)
      }
    }
